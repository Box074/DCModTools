...
namespace Packer
{
	public class Bin2DGuillotine : Bin2D
	{
		...
		{
			Bin2DNodeGuillotine bin2DNodeGuillotine = m_Root.Insert(_id, _elementSize, base.margin, base.marginType);
		...
		protected override void Reset()
		{
            ...
            {
                area = new Rectangle(0, 0, base.size.Width, base.size.Height)
            };
        }
