	...
	public class Bin2DNodeGuillotine
	{
		...
		public Bin2DNodeGuillotine Insert(uint _id, Size _size, Size _margins, MarginType _marginType)
		{
			...
			else
			{
				...
				m_LeftChild.m_Border = Bin2DNodeGuillotine.BorderType.None;
				m_RightChild.m_Border = Bin2DNodeGuillotine.BorderType.None;
				int num = area.Width - sizeWithMargin.Width;
				int num2 = area.Height - sizeWithMargin.Height;
				if (num > num2)
				{
					m_LeftChild.m_Border = ((m_Border & Bin2DNodeGuillotine.BorderType.Left) | (m_Border & Bin2DNodeGuillotine.BorderType.Top) | (m_Border & Bin2DNodeGuillotine.BorderType.Bottom));
					...
					m_RightChild.m_Border = ((m_Border & Bin2DNodeGuillotine.BorderType.Right) | (m_Border & Bin2DNodeGuillotine.BorderType.Top) | (m_Border & Bin2DNodeGuillotine.BorderType.Bottom));
					m_RightChild.area = new Rectangle(area.Left + sizeWithMargin.Width, area.Top, area.Width - sizeWithMargin.Width, area.Height);
				}
				else
				{
					m_LeftChild.m_Border = ((m_Border & Bin2DNodeGuillotine.BorderType.Left) | (m_Border & Bin2DNodeGuillotine.BorderType.Top) | (m_Border & Bin2DNodeGuillotine.BorderType.Right));
					sizeWithMargin = GetSizeWithMargin(_size, _margins, _marginType);
					m_LeftChild.area = new Rectangle(area.Location, new Size(area.Width, sizeWithMargin.Height));
					m_RightChild.m_Border = ((m_Border & Bin2DNodeGuillotine.BorderType.Left) | (m_Border & Bin2DNodeGuillotine.BorderType.Bottom) | (m_Border & Bin2DNodeGuillotine.BorderType.Right));
		...
		private Size GetSizeWithMargin(Size _sizeWithoutMargins, Size _margin, MarginType _marginType)
		{
			...
			if ((_marginType == MarginType.OnlyBorder || _marginType == MarginType.All) && (m_Border & Bin2DNodeGuillotine.BorderType.Left) != Bin2DNodeGuillotine.BorderType.None)
			{
				result.Width += _margin.Width;
			}
			if (_marginType == MarginType.All || (_marginType == MarginType.OnlyBorder && (m_Border & Bin2DNodeGuillotine.BorderType.Right) != Bin2DNodeGuillotine.BorderType.None) || (_marginType == MarginType.NoBorder && (m_Border & Bin2DNodeGuillotine.BorderType.Right) == Bin2DNodeGuillotine.BorderType.None))
			{
				result.Width += _margin.Width;
			}
			if ((_marginType == MarginType.OnlyBorder || _marginType == MarginType.All) && (m_Border & Bin2DNodeGuillotine.BorderType.Top) != Bin2DNodeGuillotine.BorderType.None)
			{
				result.Height += _margin.Height;
			}
			if (_marginType == MarginType.All || (_marginType == MarginType.OnlyBorder && (m_Border & Bin2DNodeGuillotine.BorderType.Bottom) != Bin2DNodeGuillotine.BorderType.None) || (_marginType == MarginType.NoBorder && (m_Border & Bin2DNodeGuillotine.BorderType.Bottom) == Bin2DNodeGuillotine.BorderType.None))
			{
				result.Height += _margin.Height;
			}
			return result;
